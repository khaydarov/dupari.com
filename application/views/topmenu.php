			...
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href=""><img src="http://dupari.com/assets/img/log.png" alt=""></a>
				</div>
				...
				<div class="collapse navbar-collapse" id="top-navbar-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li>
							<a href="about.html"><i class="fa fa-user"></i><br>О нас</a>
						</li>
						<li>
							<a href="contact.html"><i class="fa fa-envelope"></i><br>Контакты</a>
						</li>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000">
